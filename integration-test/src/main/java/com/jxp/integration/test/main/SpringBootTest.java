...
//    public static Class<?> classLoader(String className, CustomerClassLoader classLoader) {
//        if (classLoader == null) {
...
//
//    @Nullable
//    public static CustomerClassLoader getDefaultClassLoader() {
//        CustomerClassLoader cl = null;
//
//        try {
...
//            if (cl == null) {
//                try {
//                    cl = CustomerClassLoader.getSystemClassLoader();
